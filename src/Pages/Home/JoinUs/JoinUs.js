  ...
  return (
    <section class="bg-white dark:bg-gray-900">
      <div class="container flex flex-col items-center px-4 py-12 mx-auto text-center">
        <h2 class="md:text-5xl tex-2xl font-semibold tracking-tight text-gray-700 sm:text-4xl dark:text-white">
        ...
        <div class="mt-6 sm:-mx-2">
          <div class="inline-flex w-full sm:w-auto sm:mx-2">
            <a
              href=""
              class="inline-flex items-center justify-center w-full px-5 py-2 text-white bg-[#1e3a8a] rounded-lg hover:bg-[#152863] focus:ring focus:ring-blue-300 focus:ring-opacity-80"
            >
              Join us Now
            </a>
          </div>
