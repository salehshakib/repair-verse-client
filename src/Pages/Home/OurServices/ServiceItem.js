  ...
  return (
    <div className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
      ...
      <div className="px-6 py-4">
        ...
        <p className="py-2 text-gray-700 text-2xl dark:text-gray-400">
      ...
      <div>
        <Link to="/details">
          <button className="btn flex items-center w-5/6 mx-auto text-center border-none bg-[#1e3a8a] hover:bg-[#152863] text-white my-4 ">
            See Details
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
